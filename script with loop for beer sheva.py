...
driver.get("https://www.ad.co.il/nadlanprice?orderby=1&year=2019,2019")
...
df.to_excel("C:\\Users\\ido geminer\\Desktop\\TAU\\SEM E\\סמינר נדלן\\beer sheva excels\\beer_sheva_page1.xlsx", index=False)
print("DONE NO 1")

data = []
for i in range(264,268):
    url="https://www.ad.co.il/nadlanprice?year=2005,2007&city=beersheba&orderby=1&pageindex={0}".format(i)
    driver.get(url)
    ...
    # Create a DataFrame from the list of data
    df = pd.DataFrame(data,columns=["Date", "City", "Street", "Rooms", "Size bruto", "Floor","Price", "Price per sqm", "Build Year", "Type of Property", "Part Sold"])
    my_file_path="C:\\Users\\ido geminer\\Desktop\\TAU\\SEM E\\סמינר נדלן\\beer sheva excels\\beer_sheva_page{0}.xlsx".format(i)
    # Export the DataFrame to an Excel file
